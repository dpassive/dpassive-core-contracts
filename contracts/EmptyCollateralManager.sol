...
contract EmptyCollateralManager is ICollateralManager {
    ...
    function totalLong() external view override returns (uint susdValue, bool anyRateIsInvalid) {
        return (0, false);
    }

    function totalShort() external view override returns (uint susdValue, bool anyRateIsInvalid) {
        return (0, false);
    }
